      ...
      <g style={{ isolation: "isolate" }}>
        <g id="_1" data-name="1">
          ...
          {/* <path
            id="shelf"
            fill="#404040"
            d="M10.16 266.81H109.99V271.04H10.16z"
          ></path> */}
          <g id="light">
            <path
              id="bulb"
              ...
              <g id="vs-code">
                ...
                <g id="code">
                  ...
                  <path
                    ...
                    className="line"
                    data-name="line"
                    data-svg-origin="210.5399932861328 256.91998291015625"
                    opacity="0.39"
                    transform="matrix(0 0 0 1 210.54 0)"
                    style={{
                      WebkitTransformOrigin: 0,
                  ...
                  <path
                    ...
                    className="line"
                    data-name="line"
                    data-svg-origin="210.5399932861328 276.8600158691406"
                    opacity="0.39"
                    transform="matrix(0 0 0 1 210.54 0)"
                    style={{
                      WebkitTransformOrigin: 0,
                  ...
                  <path
                    ...
                    className="line"
                    data-name="line"
                    data-svg-origin="210.5399932861328 290.41998291015625"
                    opacity="0.39"
                    transform="matrix(0 0 0 1 210.54 0)"
                    style={{
                      WebkitTransformOrigin: 0,
                  ...
                  <path
                    ...
                    className="line"
                    data-name="line"
                    data-svg-origin="210.5399932861328 296.8600158691406"
                    opacity="0.39"
                    transform="matrix(0 0 0 1 210.54 0)"
                    style={{
                      WebkitTransformOrigin: 0,
